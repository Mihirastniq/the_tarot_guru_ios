...
import 'dart:convert';
class TheRelationSpread extends StatefulWidget {
  ...
  @override
  _TheRelationScreenState createState() => _TheRelationScreenState();
}

class _TheRelationScreenState extends State<TheRelationSpread> with TickerProviderStateMixin {
