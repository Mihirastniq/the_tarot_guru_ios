...
class TheUnificationScreen extends StatefulWidget {
  final List<SelectedCard> selectedCards;
  final String tarotType;
  final String spreadName;

  TheUnificationScreen({
  ...
  @override
  _TheUnificationScreenState createState() => _TheUnificationScreenState();
}

class _TheUnificationScreenState extends State<TheUnificationScreen> {
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Positioned(
                            top: screenHeight/2-containerHeightWithAspectRatio/2-30,
                            left: screenWidth/2-containerWidth/2-containerWidth/2 - 5,
                            child: Container(
                              decoration: BoxDecoration(
                                  color: Colors.black.withOpacity(0.3),
                                  borderRadius: BorderRadius.circular(10),
                          ...
                          Positioned(
                            ...
                            left: screenWidth/2-containerWidth/2 + (containerWidth*3)-30,
                            child: Container(
                              decoration: BoxDecoration(
                                  color: Colors.black.withOpacity(0.3),
                                  borderRadius: BorderRadius.circular(10),
                          ...
                          GestureDetector(
                            ...
                            child: Align(
                              ...
                              child: PositionedCardFinal(
                                  ...
                                  initialPosition: Offset(screenWidth/2-containerWidth/2 + containerWidth/2 + 5,screenHeight/2-containerHeightWithAspectRatio/2-30), // Align to bottom left
                          ...
                          GestureDetector(
                            ...
                            child: Align(
                              ...
                              child: PositionedCardFinal(
                                  ...
                                  initialPosition: Offset(screenWidth/2-containerWidth/2 - (containerWidth*3)+30,screenHeight/2-containerHeightWithAspectRatio/2 + (containerHeightWithAspectRatio + 10)), // Align to bottom left
                                  containerChild: Container(
                                    width: containerWidth,
                                    height: containerHeightWithAspectRatio,
                                    color: Colors.transparent,
                          ...
                          GestureDetector(
                            ...
                            child: Align(
                              ...
                              child: PositionedCardFinal(
                                  ...
                                  initialPosition: Offset(screenWidth/2-containerWidth/2,screenHeight/2-containerHeightWithAspectRatio/2+30), // Align to bottom left
                                  containerChild: Container(
                                    width: containerWidth,
                                    height: containerHeightWithAspectRatio,
                                    color: Colors.transparent,
