...
class AudioController extends GetxController {
  ...
  final List<String> oshoAudioList = [
    ...
    '02_MANIFESTO 6.19 OSHO ZEN TAROT (MUSIC FOR TAROT READING).mp3',
    '03_HERE IN MY HEART 3.23 OSHO ZEN TAROT (MUSIC FOR TAROT READING).mp3',
    '04_DOORWAY TO THE HEART 3.23 OSHO ZEN TAROT (MUSIC FOR TAROT READING).mp3',
    '05_LORD OF THE FULL MOON 4.17 OSHO ZEN TAROT (MUSIC FOR TAROT READING).mp3',
    '06_WINGS OF LOVE 5.24 OSHO ZEN TAROT (MUSIC FOR TAROT READING).mp3',
    '07_NAMASTE 3.45 OSHO ZEN TAROT (MUSIC FOR TAROT READING).mp3',
    '08_UNFOLDING MYSTERY 8.09 OSHO ZEN TAROT (MUSIC FOR TAROT READING).mp3',
    '09_UNION MYSTICA 2.44 OSHO ZEN TAROT (MUSIC FOR TAROT READING).mp3',
    '10_THE EMPTY HEART 3.16 OSHO ZEN TAROT (MUSIC FOR TAROT READING).mp3',
    '11_CLOUD OVER LOTUS 6.50 OSHO ZEN TAROT (MUSIC FOR TAROT READING).mp3',
    '12_THE GREAT PILGRIMAGE 3.47 OSHO ZEN TAROT (MUSIC FOR TAROT READING).mp3',
    '13_SPIRITUAL HEART 8.44 OSHO ZEN TAROT (MUSIC FOR TAROT READING).mp3',
  ];
