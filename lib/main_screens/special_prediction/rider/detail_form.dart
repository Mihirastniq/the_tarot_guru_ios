...
import 'package:the_tarot_guru/main_screens/special_prediction/rider/rider_prediction.dart';

class RiderWaiteSpecialPredictionDetailFormScreen extends StatefulWidget {
  const RiderWaiteSpecialPredictionDetailFormScreen({super.key});

  @override
  State<RiderWaiteSpecialPredictionDetailFormScreen> createState() => _SpecialPredictionDetailFormScreenState();
}

class _SpecialPredictionDetailFormScreenState extends State<RiderWaiteSpecialPredictionDetailFormScreen> {
    ...
    if (_formKey.currentState?.validate() ?? false) {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => SpecialPredictionRiderPrediction(randomNumbers: _randomNumbers),
          ),
        );
