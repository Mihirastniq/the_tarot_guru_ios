...
class RiderEightCardScreen extends StatefulWidget {
  final List<SelectedCard> selectedCards;
  final String tarotType;
  final String spreadName;

  RiderEightCardScreen({
  ...
  @override
  _RiderEightCardScreenState createState() => _RiderEightCardScreenState();
}

class _RiderEightCardScreenState extends State<RiderEightCardScreen> {
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Positioned(
                            top: screenHeight/2 - containerHeightWithAspectRatio/2 - (containerHeightWithAspectRatio + 5),
                            left: screenWidth/2 - containerWidth/2 - (containerWidth+10),
                            child:Container(
                              width: containerWidth,
                              height: containerHeightWithAspectRatio,
                          ...
                          Positioned(
                            top: screenHeight/2 - containerHeightWithAspectRatio/2 - (containerHeightWithAspectRatio*2 + 5),
                            left: screenWidth/2 - containerWidth/2 + 15,
                            child:Container(
                              width: containerWidth,
                              height: containerHeightWithAspectRatio,
                              decoration: BoxDecoration(
                          ...
                          Positioned(
                            top: screenHeight/2 - containerHeightWithAspectRatio/2 - (containerHeightWithAspectRatio + 5),
                            left: screenWidth/2 - containerWidth/2 + containerWidth + 20,
                            child:Container(
                              width: containerWidth,
                              height: containerHeightWithAspectRatio,
                              decoration: BoxDecoration(
                          ...
                          Positioned(
                            top: screenHeight/2 - containerHeightWithAspectRatio/2 + (containerHeightWithAspectRatio*2),
                            left: screenWidth/2 - containerWidth/2 + containerWidth + containerWidth + 20,
                            child:Container(
                              width: containerWidth,
                              height: containerHeightWithAspectRatio,
                              decoration: BoxDecoration(
                          ...
                          GestureDetector(
                            ...
                            child: Align(
                              ...
                              child: PositionedCardFinal(
                                  ...
                                  initialPosition: Offset(screenWidth/2 - containerWidth/2 -(containerWidth*2 +15),screenHeight/2 - containerHeightWithAspectRatio/2 + (containerHeightWithAspectRatio*2)), // Align to bottom left
                          ...
                          GestureDetector(
                            ...
                            child: Align(
                              ...
                              child: PositionedCardFinal(
                                  ...
                                  initialPosition: Offset(screenWidth/2 - containerWidth/2 - (containerWidth+10),screenHeight/2 - containerHeightWithAspectRatio/2 - (containerHeightWithAspectRatio + 5)), // Align to bottom left
                                  containerChild: Container(
                                    width: containerWidth,
                                    height: containerHeightWithAspectRatio,
                                    color: Colors.transparent,
                          ...
                          GestureDetector(
                            ...
                            child: Align(
                              ...
                              child: PositionedCardFinal(
                                  ...
                                  initialPosition: Offset(screenWidth/2 - containerWidth/2 + 15,screenHeight/2 - containerHeightWithAspectRatio/2 - (containerHeightWithAspectRatio*2 + 5)), // Align to bottom left
                                  containerChild: Container(
                                    width: containerWidth,
                                    height: containerHeightWithAspectRatio,
                                    color: Colors.transparent,
                          ...
                          GestureDetector(
                            ...
                            child: Align(
                              ...
                              child: PositionedCardFinal(
                                  ...
                                  initialPosition: Offset(screenWidth/2 - containerWidth/2 + containerWidth + 20,screenHeight/2 - containerHeightWithAspectRatio/2 - (containerHeightWithAspectRatio + 5)), // Align to bottom left
                                  containerChild: Container(
                                    width: containerWidth,
                                    height: containerHeightWithAspectRatio,
                                    color: Colors.transparent,
                          ...
                          GestureDetector(
                            ...
                            child: Align(
                              ...
                              child: PositionedCardFinal(
                                  ...
                                  initialPosition: Offset(screenWidth/2 - containerWidth/2 + containerWidth + 20,screenHeight/2 - containerHeightWithAspectRatio/2 + containerHeightWithAspectRatio), // Align to bottom left
                                  containerChild: Container(
                                    width: containerWidth,
                                    height: containerHeightWithAspectRatio,
                                    color: Colors.transparent,
                          ...
                          GestureDetector(
                            ...
                            child: Align(
                              ...
                              child: PositionedCardFinal(
                                  ...
                                  initialPosition: Offset(screenWidth/2 - containerWidth/2 + containerWidth + containerWidth + 20,screenHeight/2 - containerHeightWithAspectRatio/2 + (containerHeightWithAspectRatio*2)), // Align to bottom left
                                  containerChild: Container(
                                    width: containerWidth,
                                    height: containerHeightWithAspectRatio,
                                    color: Colors.transparent,
