...
class RiderSixCardScreen extends StatefulWidget {
  ...
  @override
_RiderSixCardScreenState createState() => _RiderSixCardScreenState();
}

class _RiderSixCardScreenState extends State<RiderSixCardScreen> with TickerProviderStateMixin {
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Align(
                                      ...
                                      child: PositionedCardFinal(
                                          ...
                                          initialPosition: Offset(screenWidth/2 - containerWidth/2 - containerWidth - 10,screenHeight/2 - containerHeightWithAspectRatio/2 - containerHeightWithAspectRatio/2 - 5), // Align to bottom left
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Align(
                                      ...
                                      child: PositionedCardFinal(
                                          ...
                                          initialPosition: Offset(screenWidth/2 - containerWidth/2,screenHeight/2 - containerHeightWithAspectRatio/2 - containerHeightWithAspectRatio/2 - 5), // Align to bottom left
                                          containerChild: Container(
                                            width: containerWidth,
                                            height: containerHeightWithAspectRatio,
                                            color: Colors.transparent,
