...
class RiderElcemistCardScreen extends StatefulWidget {

  final List<SelectedCard> selectedCards;
  final String tarotType;
  final String spreadName;

  RiderElcemistCardScreen({
  ...
  @override
  _RiderElcemistCardScreenState createState() => _RiderElcemistCardScreenState();
}

class _RiderElcemistCardScreenState extends State<RiderElcemistCardScreen> with TickerProviderStateMixin {
                              ...
                              child: Container(
                                ...
                                child: Stack(
                                  children: [
                                    ...
                                    Positioned(
                                      top: screenHeight/2 - containerHeightWithAspectRatio/2+containerHeightWithAspectRatio/2 + 15,
                                      left: screenWidth/2 - containerWidth*2,
                                      child:Container(
                                        width: containerWidth,
                                        height: containerHeightWithAspectRatio,
                                    ...
                                    Positioned(
                                      top: screenHeight/2 - containerHeightWithAspectRatio/2+containerHeightWithAspectRatio/2 + 15,
                                      left: screenWidth/2 + containerWidth,
                                      child:Container(
                                        width: containerWidth,
                                        height: containerHeightWithAspectRatio,
                                        decoration: BoxDecoration(
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Align(
                                        ...
                                        child: PositionedCardFinal(
                                            ...
                                            initialPosition: Offset(screenWidth/2 - containerWidth/2,screenHeight/2 - containerHeightWithAspectRatio/2 -containerHeightWithAspectRatio-containerHeightWithAspectRatio), // Align to bottom left
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Align(
                                        ...
                                        child: PositionedCardFinal(
                                            ...
                                            initialPosition: Offset(screenWidth/2 - containerWidth*2,screenHeight/2 - containerHeightWithAspectRatio/2+containerHeightWithAspectRatio/2 + 15), // Align to bottom left
                                            containerChild: Container(
                                              width: containerWidth,
                                              height: containerHeightWithAspectRatio,
                                              color: Colors.transparent,
                                    ...
                                    GestureDetector(
                                      ...
                                      child: Align(
                                        ...
                                        child: PositionedCardFinal(
                                            ...
                                            initialPosition: Offset(screenWidth/2 + containerWidth,screenHeight/2 - containerHeightWithAspectRatio/2+containerHeightWithAspectRatio/2 + 15), // Align to bottom left
                                            containerChild: Container(
                                              width: containerWidth,
                                              height: containerHeightWithAspectRatio,
                                              color: Colors.transparent,
