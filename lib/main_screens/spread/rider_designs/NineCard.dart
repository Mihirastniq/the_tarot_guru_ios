...
class RiderNineCardScreen extends StatefulWidget {
  ...
  @override
  _RiderNineCardScreenState createState() => _RiderNineCardScreenState();
}

class _RiderNineCardScreenState extends State<RiderNineCardScreen> {
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Positioned(
                            left: screenWidth/2-containerWidth*2 -15 - containerWidth/2,
                            top: screenHeight/2-containerHeightWithAspectRatio/2,
                            child: Container(
                              decoration: BoxDecoration(
                                  color: Colors.black.withOpacity(0.3),
                          ...
                          GestureDetector(
                            ...
                            child: Align(
                              ...
                              child: PositionedCardFinal(
                                  ...
                                  initialPosition: Offset(screenWidth/2-containerWidth/2 - containerWidth,screenHeight/2-containerHeightWithAspectRatio/2), // Align to bottom left
                          ...
                          GestureDetector(
                            ...
                            child: Align(
                              ...
                              child: PositionedCardFinal(
                                  ...
                                  initialPosition: Offset(screenWidth/2-containerWidth/2 - containerWidth,screenHeight/2-containerHeightWithAspectRatio/2 + containerHeightWithAspectRatio + 10), // Align to bottom left
                                  containerChild: Container(
                                    width: containerWidth,
                                    height: containerHeightWithAspectRatio,
                                    color: Colors.transparent,
                          ...
                          GestureDetector(
                            ...
                            child: Align(
                              ...
                              child: PositionedCardFinal(
                                  ...
                                  initialPosition: Offset(screenWidth/2-containerWidth*2 -15 - containerWidth/2,screenHeight/2-containerHeightWithAspectRatio/2), // Align to bottom left
                                  containerChild: Container(
                                    width: containerWidth,
                                    height: containerHeightWithAspectRatio,
                                    color: Colors.transparent,
