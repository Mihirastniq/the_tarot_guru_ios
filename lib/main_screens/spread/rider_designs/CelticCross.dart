...
class RiderCelticCrossCardScreen extends StatefulWidget {
  final List<SelectedCard> selectedCards;
  final String tarotType;
  final String spreadName;

  RiderCelticCrossCardScreen({
  ...
  @override
  _RiderCelticCrossCardScreenState createState() => _RiderCelticCrossCardScreenState();
}

class _RiderCelticCrossCardScreenState extends State<RiderCelticCrossCardScreen> {
